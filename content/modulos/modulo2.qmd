...
## Visualización de rutas de trabajo y redes de transporte para empresas eléctricas

### OpenStreetMap como fuente de datos para operaciones eléctricas
...
#### Plugin QuickOSM para datos de transporte
...
### Mapas base satelitales para reconocimiento de terreno

#### Google Satellite para planificación de rutas
...
#### OpenStreetMap estándar (ya incluido por defecto)
...
### Casos de uso específicos para empresas eléctricas

#### Caso 1: Planificación de ruta de mantenimiento
...
#### Caso 2: Respuesta a emergencias
...
#### Caso 3: Expansión de red eléctrica
...
|:-------|:------------|:----|:----------------------------------|
| **SINIT** | Sistema Nacional de Información Territorial | [https://www.sinit.hn](https://www.sinit.hn) | Datos oficiales de infraestructura |
| **OpenStreetMap Honduras** | Datos colaborativos | [https://www.openstreetmap.org](https://www.openstreetmap.org) | Rutas y carreteras actualizadas |
| **HOT OSM** | Tasking Manager Honduras | [https://tasks.hotosm.org](https://tasks.hotosm.org) | Datos de emergencias y desastres |

### Ejercicios 2.2 y 2.3: Práctica integral para operaciones eléctricas

#### Ejercicio 2.2: Configuración de mapas base y datos de transporte
...
#### Ejercicio 2.3: Planificación de ruta de mantenimiento
...
- [Plugin QuickOSM — Documentación](https://quickosm.github.io/QuickOSM/)
...
- [OpenInfraMap — Infraestructura eléctrica mundial](https://openinframap.org)
- [OSM Power Infrastructure](https://wiki.openstreetmap.org/wiki/Power)
